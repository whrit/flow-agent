...
npx bot-flow@alpha sparc run architect "Agent selection improvements"

# Implement with TDD
npx bot-flow@alpha sparc run tdd "Better agent selection algorithm"
...
# Security review
npx bot-flow@alpha sparc run security-review "Review agent selection"
...
npx bot-flow@alpha swarm spawn code-review-swarm
...
npx bot-flow@alpha sparc run architect "Design user authentication system"
npx bot-flow@alpha sparc run tdd "Implement user login functionality"
npx bot-flow@alpha sparc run security-review "Review API endpoints"

# Batch mode execution (multiple modes)
npx bot-flow@alpha sparc batch architect,tdd,security-review "Build secure API"

# Full pipeline execution
npx bot-flow@alpha sparc pipeline "Complete user management system"

# TDD workflow
npx bot-flow@alpha sparc tdd "User registration feature"
```
...
npx bot-flow@alpha swarm init --topology mesh --max-agents 10
npx bot-flow@alpha swarm init --topology hierarchical --max-agents 15
npx bot-flow@alpha swarm init --topology adaptive --max-agents 8

# Spawn specialized agents
npx bot-flow@alpha swarm spawn coder
npx bot-flow@alpha swarm spawn reviewer
npx bot-flow@alpha swarm spawn tester
npx bot-flow@alpha swarm spawn system-architect

# Coordinate multi-agent tasks
npx bot-flow@alpha swarm coordinate "Build full-stack application"
```
...
npx bot-flow@alpha sparc run architect "Your feature description"

# 3. Implement with TDD
npx bot-flow@alpha sparc run tdd "Feature implementation"
...
# 5. Security review
npx bot-flow@alpha sparc run security-review "Review changes"
