...
npx bot-flow@alpha sparc modes [--verbose]

# Get detailed information about a specific mode
npx bot-flow@alpha sparc info <mode-slug>

# Execute a task in a specific SPARC mode
npx bot-flow@alpha sparc run <mode> "<task-description>"

# Run Test-Driven Development workflow
npx bot-flow@alpha sparc tdd "<feature-description>"
```
...
npx bot-flow@alpha sparc run code "implement user authentication" --namespace auth_system

# Architecture planning with verbose output
npx bot-flow@alpha sparc run architect "design microservices architecture" --verbose

# Test-driven development for payment system
npx bot-flow@alpha sparc run tdd "payment processing with validation" --namespace payments

# Security review of existing codebase
npx bot-flow@alpha sparc run security-review "audit authentication system" --verbose

# Performance optimization with non-interactive mode
npx bot-flow@alpha sparc run optimizer "optimize database queries" --non-interactive
```

#### TDD Workflow
```bash
# Interactive TDD workflow (step-by-step)
npx bot-flow@alpha sparc tdd "user registration system" --interactive

# Automated TDD workflow
npx bot-flow@alpha sparc tdd "shopping cart functionality" --namespace ecommerce

# TDD with custom configuration
npx bot-flow@alpha sparc tdd "payment gateway integration" --config ./custom-mcp.json
```
...
batchtool run --parallel \
  "npx bot-flow@alpha sparc run architect 'system design' --non-interactive" \
  "npx bot-flow@alpha sparc run security-review 'security requirements' --non-interactive" \
  "npx bot-flow@alpha sparc run researcher 'technology evaluation' --non-interactive"
```
...
batchtool pipeline \
  --stage1 "npx bot-flow@alpha sparc run ask 'gather requirements' --non-interactive" \
  --stage2 "npx bot-flow@alpha sparc run architect 'design system' --non-interactive" \
  --stage3 "npx bot-flow@alpha sparc run code 'implement features' --non-interactive" \
  --stage4 "npx bot-flow@alpha sparc run tdd 'create test suite' --non-interactive"
```
...
batchtool orchestrate --boomerang \
  --research "npx bot-flow@alpha sparc run researcher 'best practices' --non-interactive" \
  --design "npx bot-flow@alpha sparc run architect 'system design' --non-interactive" \
  --implement "npx bot-flow@alpha sparc run code 'feature implementation' --non-interactive" \
  --test "npx bot-flow@alpha sparc run tdd 'validation suite' --non-interactive" \
  --refine "npx bot-flow@alpha sparc run optimizer 'performance tuning' --non-interactive"
```
...
batchtool run --max-parallel 3 \
  "npx bot-flow@alpha sparc run code 'user service' --namespace users --non-interactive" \
  "npx bot-flow@alpha sparc run code 'order service' --namespace orders --non-interactive" \
  "npx bot-flow@alpha sparc run code 'payment service' --namespace payments --non-interactive" \
  "npx bot-flow@alpha sparc run integration 'service communication' --namespace integration --non-interactive"
```
...
npx bot-flow@alpha sparc tdd "shopping cart with discounts" --interactive

# Automated TDD with custom namespace
npx bot-flow@alpha sparc tdd "payment validation system" --namespace payments

# TDD with integration testing focus
npx bot-flow@alpha sparc run tdd "API endpoint with database" --namespace api_tests
```
...
npx bot-flow@alpha memory store <namespace>_progress "Current implementation status"
npx bot-flow@alpha memory store <namespace>_decisions "Key architectural decisions"
npx bot-flow@alpha memory store <namespace>_blockers "Current impediments"

# Query previous work and context
npx bot-flow@alpha memory query <namespace>
npx bot-flow@alpha memory query <namespace>_architecture
npx bot-flow@alpha memory query <namespace>_requirements

# List all namespaces
npx bot-flow@alpha memory list
```
...
npx bot-flow@alpha sparc run architect "design user system" --namespace user_feature

# Coder implements based on architect's design
npx bot-flow@alpha sparc run code "implement user CRUD" --namespace user_feature

# Tester validates implementation
npx bot-flow@alpha sparc run tdd "test user operations" --namespace user_feature
...
npx bot-flow@alpha sparc run ask "e-commerce requirements" --namespace ecommerce

# 2. System architecture
npx bot-flow@alpha sparc run architect "microservices design" --namespace ecommerce

# 3. Parallel service development
batchtool run --parallel \
  "npx bot-flow@alpha sparc run code 'user service API' --namespace ecommerce_users --non-interactive" \
  "npx bot-flow@alpha sparc run code 'product catalog API' --namespace ecommerce_products --non-interactive" \
  "npx bot-flow@alpha sparc run code 'order processing API' --namespace ecommerce_orders --non-interactive"

# 4. Integration and testing
npx bot-flow@alpha sparc run integration "service communication" --namespace ecommerce
npx bot-flow@alpha sparc run tdd "end-to-end testing" --namespace ecommerce

# 5. Security and optimization
batchtool run --parallel \
  "npx bot-flow@alpha sparc run security-review 'security audit' --namespace ecommerce --non-interactive" \
  "npx bot-flow@alpha sparc run optimizer 'performance tuning' --namespace ecommerce --non-interactive"
```
...
npx bot-flow@alpha sparc tdd "RESTful user management API" --namespace user_api

# Add authentication layer
npx bot-flow@alpha sparc run security-review "API authentication" --namespace user_api

# Performance optimization
npx bot-flow@alpha sparc run optimizer "API response times" --namespace user_api

# Documentation generation
npx bot-flow@alpha sparc run documenter "API documentation" --namespace user_api
```
...
npx bot-flow@alpha sparc run debugger "investigate login failures" --namespace bug_1234

# 2. Root cause analysis
npx bot-flow@alpha sparc run analyst "analyze authentication flow" --namespace bug_1234

# 3. Fix implementation with tests
npx bot-flow@alpha sparc run tdd "fix and test authentication" --namespace bug_1234

# 4. Security validation
npx bot-flow@alpha sparc run security-review "validate auth fix" --namespace bug_1234
```
...
npx bot-flow@alpha sparc run architect "CI/CD architecture" --namespace devops

# Pipeline implementation
npx bot-flow@alpha sparc run devops "GitHub Actions workflow" --namespace devops

# Monitoring and alerts
npx bot-flow@alpha sparc run devops "application monitoring" --namespace devops

# Documentation
npx bot-flow@alpha sparc run documenter "deployment guide" --namespace devops
```
...
```bash
# Research phase
npx bot-flow@alpha sparc run researcher "JavaScript framework comparison" --namespace tech_eval

# Architecture implications
npx bot-flow@alpha sparc run architect "framework integration design" --namespace tech_eval

# Prototype development
npx bot-flow@alpha sparc run code "proof of concept" --namespace tech_eval

# Analysis and recommendation
npx bot-flow@alpha sparc run analyst "framework recommendation" --namespace tech_eval
```
...
1. **Mode Not Found**
   ...
   - Run `npx bot-flow@alpha init --sparc` to set up SPARC environment
...
3. **Memory Namespace Conflicts**
   ...
   - Query existing namespaces with `npx bot-flow@alpha memory list`
...
Start with `npx bot-flow@alpha sparc modes` to explore available modes, and use `npx bot-flow@alpha sparc run <mode> "<task>"` to begin systematic development with SPARC.