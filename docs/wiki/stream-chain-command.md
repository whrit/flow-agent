...
npx bot-flow stream-chain help
...
🔗 stream_1755021020133
   Command: npx bot-flow stream-chain demo
   PID: 366567
...
```json
{
  ...
  "stream_9876543210": {
    "command": "npx bot-flow stream-chain pipeline analysis",
    "pid": 67890,
...
npx bot-flow hive-mind spawn "coordinator"
...
npx bot-flow swarm init --topology mesh
