...
router.get('/performance-report', (req, res)=>{
    try {
        ...
        const throughput = performanceMetrics.requestCount / (uptime / 1000 / 60);
        const errorRate = performanceMetrics.requestCount > 0 ? performanceMetrics.errorCount / performanceMetrics.requestCount * 100 : 0;
        const report = {
            timestamp: now,
