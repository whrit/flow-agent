...
export class ResearcherAgent extends BaseAgent {
    ...
    async performResearch(task) {
        ...
        const sources = task.parameters?.sources || [
            'web',
            'academic',
            'news'
        ];
...
export const createResearcherAgent = (id, config, environment, logger, eventBus, memory)=>{
    const defaultConfig = {
        autonomyLevel: 0.8,
        learningEnabled: true,
        adaptationEnabled: true,
