...
describe('Claude-Flow CLI', ()=>{
    ...
    describe('Command execution', ()=>{
        test('should execute valid command', async ()=>{
            ...
            expect(executeCommand).toHaveBeenCalledWith('init', [
                '--sparc'
            ], {});
        });
        test('should handle command with multiple arguments', async ()=>{
            ...
            expect(executeCommand).toHaveBeenCalledWith('swarm', [
                'Build a REST API'
            ], {
        ...
        test('should show error for unknown command', async ()=>{
            ...
            hasCommand.mockReturnValue(false);
            await import('../simple-cli.js');
            expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Unknown command: invalid-command'));
    ...
    describe('Error handling', ()=>{
        ...
        test('should handle missing required arguments', async ()=>{
            ...
            await import('../simple-cli.js');
            expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Missing required argument'));
        });
    });
});
