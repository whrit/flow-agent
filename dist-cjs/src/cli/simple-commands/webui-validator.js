...
export class WebUIValidator {
    ...
    async runValidation() {
        ...
        this.test('Terminal I/O Layer', ()=>{
            ...
            const hasRequiredMethods = terminal && typeof terminal.write === 'function' && typeof terminal.read === 'function' && typeof terminal.exit === 'function';
...
//# sourceMappingURL=webui-validator.js.map