...
let WorkingPairSession = class WorkingPairSession {
    constructor(options = {}){
    ...
    async applyRealFixes(verificationResult) {
        ...
        if (verificationResult.lintScore < 0.8) {
            ...
            try {
                ...
                if (!stillHasErrors || afterLint.stdout.match(/error/gi)?.length < stdout.match(/error/gi)?.length) {
...
//# sourceMappingURL=pair-working.js.map