...
describe('Swarm Command', ()=>{
    ...
    describe('main swarm command', ()=>{
        ...
        test('should enable monitoring', async ()=>{
            ...
            expect(spawn).toHaveBeenCalledWith('npx', expect.arrayContaining([
                '--monitor'
            ]), expect.any(Object));
        });
    });
    ...
    describe('swarm stop', ()=>{
        test('should stop active swarm', async ()=>{
            ...
            expect(fs.remove).toHaveBeenCalledWith(path.join(process.cwd(), '.claude', 'swarm', 'swarm.json'));
        });
    ...
    describe('error handling', ()=>{
        test('should handle missing objective', async ()=>{
            await swarmCommand([], {});
            expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('objective is required'));
        });
        ...
        test('should handle spawn process errors', async ()=>{
            ...
            expect(mockSpinner.fail).toHaveBeenCalledWith(expect.stringContaining('Failed to initialize swarm'));
        });
