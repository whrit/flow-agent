...
describe('Agent Command', ()=>{
    ...
    describe('spawn subcommand', ()=>{
        ...
        test('should error if swarm not initialized', async ()=>{
            ...
            expect(mockSpinner.fail).toHaveBeenCalledWith(expect.stringContaining('No active swarm found'));
        });
    ...
    describe('remove subcommand', ()=>{
        test('should remove an agent', async ()=>{
            ...
            expect(mockSpinner.succeed).toHaveBeenCalledWith(expect.stringContaining('Agent agent-1 removed'));
            const writeCall = fs.writeJson.mock.calls[0];
            expect(writeCall[1].agents).toHaveLength(1);
        ...
        test('should error if agent not found', async ()=>{
            ...
            expect(mockSpinner.fail).toHaveBeenCalledWith(expect.stringContaining('Agent nonexistent not found'));
        });
    });
    describe('assign subcommand', ()=>{
        test('should assign task to agent', async ()=>{
            ...
            expect(mockSpinner.succeed).toHaveBeenCalledWith(expect.stringContaining('Task assigned to agent-1'));
            const writeCall = fs.writeJson.mock.calls[0];
    ...
    describe('error handling', ()=>{
        ...
        test('should handle invalid subcommands', async ()=>{
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Unknown subcommand: invalid-subcommand'));
        });
    });
});
