...
export async function copyAgentFiles(targetDir, options = {}) {
    ...
    const packageAgentsDir = join(__dirname, '../../../../.claude/agents');
    const localAgentsDir = '/workspaces/claude-code-flow/.claude/agents';
...
export async function copyCommandFiles(targetDir, options = {}) {
    ...
    const localCommandsDir = '/workspaces/claude-code-flow/.claude/commands';
    const cwdCommandsDir = join(process.cwd(), '.claude/commands');
