                ...
                case 'scan':
                    {
                        ...
                        try {
                            const scan = await manager.createSecurityScan({
                                ...
                                configuration: {
                                    severity: ctx.flags.severity ? ctx.flags.severity.split(',') : undefined,
                            ...
                            case 'train':
                                {
                                    ...
                                    try {
                                        const features = ctx.flags.features ? ctx.flags.features.split(',') : [
                                            'cpu-usage',
                                            'memory-usage'
                                        ];
                            ...
                            case 'predict':
                                {
                                    ...
                                    try {
                                        const input = ctx.flags.input ? JSON.parse(ctx.flags.input) : {
                                            'cpu-usage': 50,
                                            'memory-usage': 60
                                        };
                        ...
                        try {
                            ...
                            const filepath = await manager.exportAuditData({
                                ...
                                scope: {
                                    ...
                                    categories: ctx.flags.categories ? ctx.flags.categories.split(',') : undefined,
                                    severity: ctx.flags.severity ? ctx.flags.severity.split(',') : undefined
                                },
                ...
                case 'metrics':
                    {
                        try {
                            ...
                            const metrics = await manager.getAuditMetrics({
                                start,
                                end: now
                            });
