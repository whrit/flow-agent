...
export const wizardCommand = new Command('wizard').description('Interactive Hive Mind setup and management wizard').option('--skip-intro', 'Skip the intro animation', false).action(async (options)=>{
    try {
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            ...
            choices: [
                ...
                {
                    name: '🔄 Ring - Circular communication pattern',
                    value: 'ring'
                },
                {
...
async function spawnAgentInteractive(hiveMind) {
    const agentTypes = [
        ...
        {
            name: '💻 Coder - Code generation and implementation',
            value: 'coder'
        },
        {
            name: '📊 Analyst - Data analysis and insights',
            value: 'analyst'
        },
        {
            name: '🏗️ Architect - System design and planning',
            value: 'architect'
        },
        {
            name: '🧪 Tester - Quality assurance and testing',
            value: 'tester'
        },
        {
            name: '👁️ Reviewer - Code and design review',
            value: 'reviewer'
        },
        {
            name: '⚡ Optimizer - Performance optimization',
            value: 'optimizer'
        },
        {
            name: '📝 Documenter - Documentation generation',
            value: 'documenter'
        },
        {
            name: '📡 Monitor - System monitoring and alerts',
            value: 'monitor'
        },
        {
            name: '🎨 Specialist - Custom specialized agent',
            value: 'specialist'
        }
    ];
    const answers = await inquirer.prompt([
...
async function submitTaskWizard() {
    ...
    const config = await inquirer.prompt([
        ...
        },
        {
            ...
            choices: [
                {
                    name: '🤖 Adaptive (AI-optimized)',
                    value: 'adaptive'
                },
                {
                    name: '⚡ Parallel (Multiple agents)',
                    value: 'parallel'
                },
                {
                    name: '📍 Sequential (Step-by-step)',
                    value: 'sequential'
                },
                {
                    name: '🤝 Consensus (Requires agreement)',
                    value: 'consensus'
                }
            ],
            default: 'adaptive'
