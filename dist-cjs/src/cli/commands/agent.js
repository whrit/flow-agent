...
export function createAgentCommand() {
    const agentCommand = new Command('agent').description('Comprehensive Claude-Flow agent management with advanced features').action(()=>{
