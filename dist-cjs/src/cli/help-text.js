...
export function getStandardizedCommandHelp(command) {
    const commandConfigs = {
        agent: {
            ...
            commands: [
                ...
                {
                    name: 'hierarchy',
                    description: 'Manage agent hierarchies'
                },
                {
                    name: 'ecosystem',
                    description: 'View agent ecosystem'
                }
            ],
            options: [
                {
        ...
        sparc: {
            ...
            commands: [
                {
                    name: 'spec',
                    description: 'Specification mode - Requirements analysis'
                },
                {
                    name: 'architect',
                    description: 'Architecture mode - System design'
                },
                {
                    name: 'tdd',
                ...
                {
                    name: 'integration',
                    description: 'Integration mode - Component connection'
                },
                {
                    name: 'refactor',
                    description: 'Refactoring mode - Code improvement'
                },
                {
                    name: 'modes',
        ...
        memory: {
            ...
            commands: [
                ...
                {
                    name: 'clear',
                    description: 'Clear memory namespace'
                }
            ],
            options: [
                {
    ...
    if (!config) {
        return HelpFormatter.formatError(`Unknown command: ${command}`, 'claude-flow', 'claude-flow <command> --help');
    }
