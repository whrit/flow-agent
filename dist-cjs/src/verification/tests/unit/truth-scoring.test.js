...
describe('Truth Scoring System', ()=>{
    ...
    describe('Claim vs Reality Comparison', ()=>{
        ...
        test('should detect false claims about test results', ()=>{
            ...
            expect(comparison.truth_score).toBe(0.5);
        });
    ...
    describe('Truth Score Storage', ()=>{
        ...
        test('should create memory directory if it does not exist', async ()=>{
            ...
            await fs.rm(calculator.memoryPath, {
                recursive: true,
                force: true
            });
    ...
    describe('Agent History Tracking', ()=>{
        beforeEach(async ()=>{
            await fs.mkdir(calculator.memoryPath, {
                recursive: true
            });
            const testData = [
                {
            ...
            for (const data of testData){
                ...
                await fs.writeFile(path.join(calculator.memoryPath, filename), JSON.stringify(data, null, 2));
            }
        });
    ...
    describe('Edge Cases and Error Handling', ()=>{
        ...
        test('should handle very large numbers in evidence', ()=>{
            const evidence = {
                test_results: {
                    passed: Number.MAX_SAFE_INTEGER,
...
//# sourceMappingURL=truth-scoring.test.js.map